...
public class BookingDataDTO {
    ...
    {
        return "BookingDataDTO [User_ID = "+User_ID+", location_longitude = "+location_longitude+", vehicle_type = "+vehicle_type+", bike_detailing = "+bike_detailing+", car_detailing = "+car_detailing+", request = "+request+", location_address = "+location_address+", location_latitude = "+location_latitude+", car_package = "+car_package+", car_type = "+car_type+"]";
    }
